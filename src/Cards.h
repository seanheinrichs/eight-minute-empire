...
public:
    ...
    const Cards cards04 = Cards((string *) "Diamond", (string *)"PLACE_NEW_ARMIES_ON_BOARD 2");
    const Cards cards05 = Cards((string *) "Diamond", (string *)"PLACE_NEW_ARMIES_ON_BOARD 2");
    const Cards cards06 = Cards((string *) "Diamond", (string *)"PLACE_NEW_ARMIES_ON_BOARD 2");
    const Cards cards07 = Cards((string *) "Diamond", (string *)"PLACE_NEW_ARMIES_ON_BOARD 1");
    const Cards cards08 = Cards((string *) "Diamond", (string *)"MOVE_OVER_LAND 2");
    const Cards cards09 = Cards((string *) "Coal", (string *)"MOVE_OVER_LAND 2");
    const Cards cards10 = Cards((string *) "Coal", (string *)"MOVE_OVER_WATER 2");
    const Cards cards11 = Cards((string *) "Coal", (string *)"MOVE_OVER_WATER 2");
    const Cards cards12 = Cards((string *) "Coal", (string *)"MOVE_OVER_WATER 3");
    const Cards cards13 = Cards((string *) "Coal", (string *)"PLACE_NEW_ARMIES_ON_BOARD 3");
    const Cards cards14 = Cards((string *) "Coal", (string *)"PLACE_NEW_ARMIES_ON_BOARD 3");
    const Cards cards15 = Cards((string *) "Coal", (string *)"PLACE_NEW_ARMIES_ON_BOARD 2 OR BUILD_A_CITY");
