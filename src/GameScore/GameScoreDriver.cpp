...
//    Player *jj = new Player("jj", 3, 17);
//    Deck deck1;
//    std::vector<Cards*> tb = deck1.topBoardGenetor(deck1);
//    std::vector<Cards*> *hand = new std::vector<Cards*>();
//    deck1.exchange(*ss, tb, deck1);
//    deck1.exchange(*mm, tb, deck1);
//    deck1.exchange(*jj, tb, deck1);
//    deck1.exchange(*ss, tb, deck1);
//    deck1.exchange(*mm, tb, deck1);
//    deck1.exchange(*jj, tb, deck1);
//    deck1.exchange(*ss, tb, deck1);
...
//    deck1.displayHand(*ss->getGameHand());
//    deck1.displayHand(*mm->getGameHand());
//    deck1.displayHand(*jj->getGameHand());
//    cout << "=========Test GameScore( ) ===============" << endl;
